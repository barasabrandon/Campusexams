...
class ExamsPdfController extends Controller
{
    ...
    public function downloadPastpaper()
   {
        ...
        $pastpaper_content = $pastpaper->pdf;
        $pastpaper_path = public_path()."/assets/files/{{$paspaper->pdf}}";
        return Response::download($pastpaper_path,$pastpaper_content,$headers );
